...
extern void Task_TimeOfDay(void *pvParameters) {
	 ...
	 * Thus with prescaler 0 and load value 65535 the timer would expire in 0.543941 milliseconds
	 * at 65535 load value a prescaler of at least (theoretical) 18.384 but prescaler must be an integer
	 * load value * prescaler *8.3 * 10^-9 = 0.01
	 * choose prescaler 20 and then 60000 satisfies the equation
	 */
	//Set the prescaler
